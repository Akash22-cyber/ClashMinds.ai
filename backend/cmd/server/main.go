...
func setupRouter(cfg *config.Config) *gin.Engine {
	...
	allowedOrigins := []string{
		"http://localhost:5173", 
		"https://clash-minds.app", 
		"https://www.clash-minds.app",
		"https://clash-minds.vercel.app",
	}
	if frontendUrl != "" {
	...
	// Health check endpoint explicitly for verification
	router.GET("/health", func(c *gin.Context) {
		c.JSON(200, gin.H{"status": "ok", "version": "clashminds-v2"})
	})
